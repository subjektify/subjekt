...
export class SubjektParser extends Parser {
	...
	public static readonly ruleNames: string[] = [
		...
		"shapeMembers", "enumMembers", "enumMember", "listMember", "mapMembers", 
		...
		"shapeIdMember", "trait", "traitBody", "value", "listValue", "objectValue", 
		"kvp", "string", "number", "namespaceIdentifier", "identifier",
	];
	...
	public shapeMembers(): ShapeMembersContext {
		let _localctx: ShapeMembersContext = new ShapeMembersContext(this._ctx, this.state);
		...
		try {
			...
			case 4:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SubjektParser.STATE) | (1 << SubjektParser.BEHAVIORS) | (1 << SubjektParser.EVENTS) | (1 << SubjektParser.AT_SIGN))) !== 0)) {
					{
					{
					this.state = 131;
					this.subjectMembers();
			...
			case 5:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SubjektParser.ERRORS) | (1 << SubjektParser.INPUT) | (1 << SubjektParser.OUTPUT) | (1 << SubjektParser.AT_SIGN))) !== 0)) {
					{
					{
					this.state = 137;
			...
			case 6:
				...
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				while (_la === SubjektParser.AT_SIGN || _la === SubjektParser.IDENTIFIER_CHARS) {
					{
					{
					this.state = 143;
					this.member();
	...
	public enumMembers(): EnumMembersContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SubjektParser.AT_SIGN) | (1 << SubjektParser.COMMA) | (1 << SubjektParser.IDENTIFIER_CHARS))) !== 0)) {
				{
				{
				this.state = 153;
				this._errHandler.sync(this);
	...
	public mapMembers(): MapMembersContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << SubjektParser.KEY) | (1 << SubjektParser.VALUE) | (1 << SubjektParser.AT_SIGN))) !== 0)) {
				{
				{
				this.state = 187;
				this.keyValuePair();
...
export class ShapeMembersContext extends ParserRuleContext {
	...
	public behaviorMembers(i?: number): BehaviorMembersContext | BehaviorMembersContext[] {
		if (i === undefined) {
	...
	// @Override
	public get ruleIndex(): number { return SubjektParser.RULE_shapeMembers; }
	// @Override
	public enterRule(listener: SubjektListener): void {
...
export class KeyValuePairContext extends ParserRuleContext {
	...
	public COLON(): TerminalNode | undefined { return this.tryGetToken(SubjektParser.COLON, 0); }
